...
wordset = {"@KILL": ["slayed", "killed"]}

#lists of templates used by the plot nodes
templates = [
    ["""As Benvolio strolled down a street in Verona, he was waylayed by a rogue group of Capulet thugs. "Thou art tresspassing on Capulet grounds!", shrieked the thugs as they senselessly beat his corpse."""],
    ["""The lovestricken Romeo pleaded with his father to court the lovely Juliet. However, Montague, still grieving after the loss of Benvolio, forbade Romeo from venturing anywhere near Capulet territory."""],
