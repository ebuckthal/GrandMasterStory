...
templates = [
    ...
    ["""Romeo reads the letter and ventures out into the city wearing clothes from his \
        ...
        However, Romeo's father has been alerted of his absense and several Montague soldiers \
    ...
    [""""This isn't the time to fight, Capulet!" Montague shouts. We shouldn't be fighting \
        ...
        and I won't allow it," Capulet replies. Montague is embarrased, but Capulet has \
    ...
    ["""In order to permanently separate Juliet and Romeo, Capulet arranges a marraige \
    ...
    ["""Once Romeo hears of the proposed marriage of Juliet, his heart swells and he \
        ...
        way their love can be realised is without the frivolous arguments between their \
        opposing families."""],
    ...
    ["""Romeo gathers up his last belonings including a heralded dagger from the family's \
    ...
    ["""Romeo's heart sank and his fists tightened. He knew that Tybalt could not get \
        ...
        rivalry!" Romeo pleads, but disregarding the possible retatiation from Capulet's \
    ...
    ["""Juliet's internal struggle realises itself when she thinks Romeo is dead. She decides \
    ...
    ["""Before Juliet has time to prepare the poison, Romeo appears and Juliet prepares to \
        jump down tothe courtyard to escape. """],
    ...
    ["""Romeo catches Juliet in the midst of her suicide. "Juliet, I'm here! What are \
        ...
        a rope down to the courtyard she kept incase the need to escape emerged."""],
    ...
    ["""Capulet corners Romeo and carefully blocks Capulet's dagger with his broomstick. \
        ...
        Capulet's immense force stands above him. "This trechery with the Montague's has \
    ...
    ["""Juliet runs into her room and finds the vial of poison. She makes her way back \
        ...
        tosses the poison into Capulets face. "My eyes! What devil's magic is this poison!" \
